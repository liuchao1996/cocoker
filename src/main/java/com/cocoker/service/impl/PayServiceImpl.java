...
//        map.add("amount", d.toString());
        ...
        String flag = "amount=" + m + "&merchant_no=" + mid + "&merchant_order_num=" + orderId + "&notify_url=" + accountConfig.getNotifyurlY() + "&payment_type=WxPay-JSPay&return_url=" + accountConfig.getReturnurlY() + "&version=1.0&key=" + key;
